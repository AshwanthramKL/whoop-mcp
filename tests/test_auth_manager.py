...
class TestTokenManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.token_manager_patcher = patch.multiple(
            "auth_manager", TOKEN_STORAGE_PATH=self.token_path, ENCRYPTION_KEY_FILE=self.key_path
        )
    ...
    def test_encryption_key_creation(self):
        ...
        TokenManager()  # side effect: creates the encryption key file
    ...
    def test_token_expiration_check(self):
        ...
        expired_token = {"expires_at": (datetime.now() - timedelta(hours=1)).isoformat()}
